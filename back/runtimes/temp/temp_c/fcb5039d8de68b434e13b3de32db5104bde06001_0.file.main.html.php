...
function content_59c8f5b7c17ae4_63457023 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="body">
        <div class="body-box">
            ...
            <div class="body-right">
                <div class="right-box">
                    <div class="font">
                        <strong>还没有账号:&nbsp;请<a href="/index.php/main/login/register">&nbsp;注册</a></strong>
                    </div>
                </div>
            </div>
        </div>
